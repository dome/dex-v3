        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: '100%', md: '70%' } }}
            >
              While we implement multiple security measures to protect user funds, it's essential to understand that all investments carry risks. We encourage users to conduct their research and only invest what they can afford to lose.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion
