      ...
      <StyledPaper elevation={3}>
        ...
        <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1-content" id="panel1-header">
            <Typography variant="subtitle1">1. What is CO2eDEX?</Typography>
          </AccordionSummary>
          <AccordionDetails>
        ...
        <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel2-content" id="panel2-header">
            <Typography variant="subtitle1">2. How do I swap tokens on CO2eDEX?</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography variant="body2">
            To swap tokens on CO2eDEX, go to the "Swap" section on the platform, select the tokens you want to trade, enter the amount, and confirm the swap. Your new tokens will appear in your wallet once the transaction is completed.            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel4-content" id="panel4-header">
            <Typography variant="subtitle1">4. How can I provide liquidity on CO2eDEX?</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography variant="body2">
        ...
        <Accordion expanded={expanded === 'panel8'} onChange={handleChange('panel8')}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel8-content" id="panel8-header">
            <Typography variant="subtitle1">8. How does CO2eDEX ensure the security of my funds?</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography variant="body2">
            CO2eDEX uses smart contracts to manage trades and liquidity pools, which are audited to ensure security. Additionally, the platform follows best practices in DeFi security to protect user funds.            </Typography>
          </AccordionDetails>
        </Accordion>

        <Accordion expanded={expanded === 'panel9'} onChange={handleChange('panel9')}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel9-content" id="panel9-header">
            <Typography variant="subtitle1">9. What is the governance system on CO2eDEX?</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography variant="body2">
        ...
        <Accordion expanded={expanded === 'panel10'} onChange={handleChange('panel10')}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel10-content" id="panel10-header">
            <Typography variant="subtitle1">10. How can I get support if I encounter issues on CO2eDEX?</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography variant="body2">
